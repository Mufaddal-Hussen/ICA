...
//                    out.print("else working");
                   if(fileItem.getFieldName().equals("songname"))
                   {
//                       out.print("actor name working");
                       songname=fileItem.getString();
                       
                      
                   }
                   if(fileItem.getFieldName().equals("songabout"))
                   {
//                       out.print("actor about working");
                       songabout=fileItem.getString();
...
//                conn = DriverManager.getConnection("jdbc:derby://localhost:1527/voting", "root", "root");
                ...
                ps = conn.prepareStatement("insert into song(song_name,song_about,song_image) values(?,?,?)");
                ps.setString(1, songname);
                ps.setString(2, songabout);
