...
//                    out.print("else working");
                   if(fileItem.getFieldName().equals("singername"))
                   {
//                       out.print("actor name working");
                       singername=fileItem.getString();
                       
                      
                   }
                   if(fileItem.getFieldName().equals("singerabout"))
                   {
//                       out.print("actor about working");
                       singerabout=fileItem.getString();
...
//                conn = DriverManager.getConnection("jdbc:derby://localhost:1527/voting", "root", "root");
                ...
                ps = conn.prepareStatement("insert into singer(singer_name,singer_about,singer_image) values(?,?,?)");
                ps.setString(1, singername);
                ps.setString(2, singerabout);
