<%-- 
    Document   : admin
    Created on : 19 Apr, 2021, 2:19:22 PM
    Author     : Dell
--%>
...
<body>
    ...
    //                conn = DriverManager.getConnection("jdbc:derby://localhost:1527/voting", "root", "root");
                ...
                while (rs.next()) {
                int count=0;
                    PreparedStatement pscount=conn.prepareStatement("select count(*) from best_movie where movie_name='"+rs.getString("movie_name")+"'");
...
count=rscount.getInt(1);
            ...
            <tr>
             ...
             <td><%=count%> </td>
                <td><a href="delete?movie_name=<%=rs.getString(1)%>">Delete</a></td>
        ...
        <div id="actordiv">
            ...
            <input type="text" name="actorabout"><br>
            <label>Enter Actor image </label>
            <input type="file" name="actorimage"><br>
            <input type="submit" value="Enter"><br>
            </form>
    ...
    //                conn = DriverManager.getConnection("jdbc:derby://localhost:1527/voting", "root", "root");
              ...
              ResultSet rs2 = ps2.executeQuery();
                ...
                while (rs2.next()) {
                    int counta=0;
              PreparedStatement pscount2=conn2.prepareStatement("select count(*) from best_actor where actor_name='"+rs2.getString("actor_name")+"'");
               ResultSet rscount2= pscount2.executeQuery();
               if(rscount2.next())
{
counta=rscount2.getInt(1);
}
         %>
            ...
            <tr>
             ...
             <td><%=counta%></td>
                <td><a href="delete?actor_name=<%=rs2.getString(1)%>">Delete</a></td>
        ...
        <div id="actressdiv">
            ...
            <input type="text" name="actressabout"><br>
            <label>Enter Actress image </label>
            <input type="file" name="actressimage"><br>
            <input type="submit" value="Enter"><br>
            </form>
    ...
    //                conn = DriverManager.getConnection("jdbc:derby://localhost:1527/voting", "root", "root");
              ...
              ResultSet rs3 = ps3.executeQuery();
                ...
                while (rs3.next()) {
                    int countb=0;
                    PreparedStatement pscount3=conn3.prepareStatement("select count(*) from best_actress where actress_name='"+rs3.getString("actress_name")+"'");
               ResultSet rscount3= pscount3.executeQuery();
               if(rscount3.next())
{
countb=rscount3.getInt(1);
}
           %>
            ...
            <tr>
             ...
             <td><%=countb%> </td>
                <td><a href="delete?actress_name=<%=rs3.getString(1)%>">Delete</a></td>
        ...
        <div id="songdiv">
            ...
            <input type="text" name="songabout"><br>
            <label>Enter Song image </label>
            <input type="file" name="songimage"><br>
            <input type="submit" value="Enter"><br>
            </form>
    ...
    //                conn = DriverManager.getConnection("jdbc:derby://localhost:1527/voting", "root", "root");
              ...
              ResultSet rs4 = ps4.executeQuery();
                ...
                while (rs4.next()) {
                    int countc=0;
                    PreparedStatement pscount4=conn4.prepareStatement("select count(*) from best_song where song_name='"+rs4.getString("song_name")+"'");
               ResultSet rscount4= pscount4.executeQuery();
               if(rscount4.next())
{
countc=rscount4.getInt(1);
}
            %>
            ...
            <tr>
             ...
             <td> <%=countc%></td>
                <td><a href="delete?song_name=<%=rs4.getString(1)%>">Delete</a></td>
        ...
        <div id="singerdiv">
            ...
            <input type="text" name="singername"><br>
            <label>Enter about Singer</label>
            <input type="text" name="singerabout"><br>
            <label>Enter Singer image </label>
            <input type="file" name="singerimage"><br>
            <input type="submit" value="Enter"><br>
            </form>
    ...
    //                conn = DriverManager.getConnection("jdbc:derby://localhost:1527/voting", "root", "root");
                ...
                ps5 = conn5.prepareStatement("select * from singer");
              ResultSet rs5 = ps5.executeQuery();

                while (rs5.next()) {
                    int countd=0;
                    PreparedStatement pscount5=conn5.prepareStatement("select count(*) from best_singer where singer_name='"+rs5.getString("singer_name")+"'");
               ResultSet rscount5= pscount5.executeQuery();
               if(rscount5.next())
{
countd=rscount5.getInt(1);
}
%>
            ...
            <tr>
             ...
             <td><%=countd%> </td>
                <td><a href="delete?singer_name=<%=rs5.getString(1)%>">Delete</a></td>
        ...
        <div id="showdiv">
            ...
            <input type="text" name="showname"><br>
            <label>Enter about TV Shhow</label>
            <input type="text" name="showabout"><br>
            <label>Enter TV Show image </label>
            <input type="file" name="showimage"><br>
            <input type="submit" value="Enter"><br>
            </form>
    ...
    //                conn = DriverManager.getConnection("jdbc:derby://localhost:1527/voting", "root", "root");
              ...
              ResultSet rs6 = ps6.executeQuery();
                ...
                while (rs6.next()) {
                    int counte=0;
                    PreparedStatement pscount6=conn6.prepareStatement("select count(*) from best_show where show_name='"+rs6.getString("show_name")+"'");
               ResultSet rscount6= pscount6.executeQuery();
               if(rscount6.next())
{
counte=rscount6.getInt(1);
}
            %>
            ...
            <tr>
             ...
             <td><%=counte%></td>
                <td><a href="delete?show_name=<%=rs6.getString(1)%>">Delete</a></td>
